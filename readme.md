...
# Requisitos previos para Windows .Net framework:
	```1 Tener instalado iis (Internet Information Services)```
	
	#Instalación del proveedor de servicios en iis
	```
	1 Abrir iis
	2 Crear un sitio
		2.1 Agregar Grupo de aplicación
	3 Copiar los componentes de la carpeta /iis_handler/bin del repositorio [svr-se-contabilidad-nomina] a la carpeta física del grupo de aplicación
	4 configurar el archivo paths.cfg (la configuración de este archivo es muy importante para el proveedor de servicios ya de ahí toma las rutas de configuración para su funcionamiento)
